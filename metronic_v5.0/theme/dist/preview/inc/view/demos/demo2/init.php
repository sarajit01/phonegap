...
class Demo2Init {
	...
	private static function initHeaderMenuMobile() {
		Page::addClass('header_menu', 'm-aside-header-menu-mobile--skin-' . Page::getOption('layout', 'menu/header_mobile/skin'));
		Page::addClass('header_menu', 'm-aside-header-menu-mobile--submenu-skin-' . Page::getOption('layout', 'menu/header_mobile/skin'));
	}
