<div class="m-alert m-alert--icon m-alert--air m-alert--square alert alert-info alert-dismissible m--margin-bottom-30" role="alert">
	...
	<div class="m-alert__text">
		...
		For the HTML version you will just need to import the HTML template of the configured layout by choosing "Export HTML Layout" option from the export menu to
		download a zip folder with well organized HTML master tempalte with separated includable partials.</p>
		<p>
		For the Angular version you will need to choose "Generate Angular Version Layout" option to get the Angular version app source code updated automatically.
		</p>
	</div>
</div>
			...
			<div class="tab-content">
					...
					<div class="form-group m-form__group row">
						...
						<div class="col-lg-8 col-xl-4">
							<select class="form-control" name="builder[layout][self][layout]">
								<option value="wide" <?php Util::echoIf(Page::getOption('layout', 'self/layout') == 'wide', 'selected');?> >Wide</option>
				...
				<div class="tab-pane <?php Page::classValue( $tabId, '#m_builder_left_aside' ); ?>" id="m_builder_left_aside">
					...
					<div class="form-group m-form__group row m--hide">
						<label class="col-lg-4 col-form-label">Link Active State Style:</label>
						<div class="col-lg-8 col-xl-4">
							<select class="form-control" name="builder[layout][menu][aside][root-active-style]">
								<option value="default" <?php Util::echoIf(Page::getOption('layout', 'menu/aside/root-active-style') == 'default', 'selected');?> >Default</option>
								<option value="border" <?php Util::echoIf(Page::getOption('layout', 'menu/aside/root-active-style') == 'border', 'selected');?> >Border</option>
							</select>
							<div class="m-form__help">Select select menu root level link active state style</div>
						</div>
					</div>
					<div class="form-group m-form__group row">
						<label class="col-lg-4 col-form-label">Dropdown Submenu Skin:</label>
						<div class="col-lg-8 col-xl-4">
							<select class="form-control" name="builder[layout][menu][aside][submenu][dropdown][skin]">
								<option value="dark" <?php Util::echoIf(Page::getOption('layout', 'menu/aside/submenu/dropdown/skin') == 'dark', 'selected');?> >Dark</option>
								<option value="light" <?php Util::echoIf(Page::getOption('layout', 'menu/aside/submenu/dropdown/skin') == 'light', 'selected');?> >Light</option>
							</select>
						...
						<div class="dropdown m-dropdown--inline">
							<button type="submit" id="builder_export" class="dropdown-toggle1 btn btn-accent m-btn m-btn--icon m-btn--wide m-btn--air m-btn--custom" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
						  	...
						  	<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
						    	<a class="dropdown-item" id="builder_export_html" data-demo="<?php echo Page::$demo ?>" href="#"><i class="la la-download"></i> Export HTML Version Layout</a>
						    	<a class="dropdown-item" id="builder_export_angular" data-demo="<?php echo Page::$demo ?>" href="#"><i class="la la-cog"></i> Generate Angular Version Layout</a>
						  	</div>
						</div>
						<?php endif; ?>
