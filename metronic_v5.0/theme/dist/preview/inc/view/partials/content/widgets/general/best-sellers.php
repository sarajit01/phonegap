				...
				<div class="m-widget5">
					<div class="m-widget5__item">
						<div class="m-widget5__pic"> 
							<img class="m-widget7__img" src="<?php echo Page::getMediaImgPath();?>/products/product6.jpg" alt="">  
						</div>
					...
					<div class="m-widget5__item">
						<div class="m-widget5__pic"> 
							<img class="m-widget7__img" src="<?php echo Page::getMediaImgPath();?>/products/product10.jpg" alt="">
						</div>
						<div class="m-widget5__content">
							<h4 class="m-widget5__title">
								Branding Mockup
					...
					<div class="m-widget5__item">
						<div class="m-widget5__pic"> 
							<img class="m-widget7__img" src="<?php echo Page::getMediaImgPath();?>/products/product11.jpg" alt=""> 
						</div>
						<div class="m-widget5__content">
							<h4 class="m-widget5__title">
								Awesome Mobile App
