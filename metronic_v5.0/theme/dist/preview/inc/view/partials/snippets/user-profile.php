<?php 
	...
	$m_profile_menu_class = 'col-lg-3';
	$m_profile_content_class = 'col-lg-9';
...
<div class="row">
	<div class="<?php echo $m_profile_menu_class?>">
		<div class="m-portlet m-portlet--full-height <?php echo $m_portlet_class?>">
	...
	<div class="<?php echo $m_profile_content_class?>">
		<div class="m-portlet m-portlet--full-height m-portlet--tabs <?php echo $m_portlet_class?>">
